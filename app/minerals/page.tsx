            ...
            {mineralPrices.map((mineral, index) => (
              ...
              >
                ...
                <div className="p-6">
                  ...
                  {/* Applications */}
                  <div className="mb-4">
                    <h4 className="font-normal text-primary-dark mb-2 text-sm">Applications</h4>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            <div className="bg-white rounded-2xl shadow-md hover:shadow-xl p-8 text-center transition-all duration-300 border border-primary-light transform hover:-translate-y-2">
              ...
              <h3 className="text-xl md:text-2xl font-normal mb-3 text-primary-dark">ISO Certified Suppliers</h3>
            ...
            <div className="bg-white rounded-2xl shadow-md hover:shadow-xl p-8 text-center transition-all duration-300 border border-primary-light transform hover:-translate-y-2">
              ...
              <h3 className="text-xl md:text-2xl font-normal mb-3 text-primary-dark">Third-Party Testing</h3>
              <p className="text-primary-dark font-light text-sm md:text-base">
              ...
              >
                <div className="flex items-start mb-3">
                  ...
                  <div className="flex-1">
                    <h3 className="font-normal text-primary-dark text-base md:text-lg mb-1">{mine.name}</h3>
                    <p className="text-sm text-primary-dark font-light opacity-75">{mine.location}, {mine.state}</p>
                  </div>
                </div>
